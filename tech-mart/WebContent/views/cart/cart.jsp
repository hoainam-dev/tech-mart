                ...
                <div class="col-md-4">
                    ...
                    <div class="single-sidebar">
                        ...
                        <div class="thubmnail-recent">
                            <img src="static/img/product-2.jpg" class="recent-thumb" alt="">
                                    ...
                                    <% if(cart_list != null){
                                    	for(Cart c:cartProduct){%>
                                            ...
                                            <td class="product-remove">
                                                <a title="Remove this item" class="remove" href="remove-from-cart?id=<%= c.getId() %>">×</a> 
                                            </td>

                                            <td class="product-thumbnail">
                                            
                                                <a href="single-product.html"><img src="static/img/<%= c.getImage() %>" alt=""></a>
                                            </td>

                                            <td class="product-name">
                                                <a href="single-product.html"><%= c.getName() %></a> 
                                            </td>
                                            ...
                                            <td class="product-quantity">
                                                <div class="quantity buttons_added">
                                                		<a class="btn btn-sm btn-decre" href="quantity-inc-dec?action=dec&id=<%=c.getId()%>">-</i></a>
                                                		<input type="text" name="quantity" size="4" class="btn btn-outline-dark"  value="<%=c.getQuantity()%>" readonly> 
					                                    <a class="btn bnt-sm btn-incre" href="quantity-inc-dec?action=inc&id=<%=c.getId()%>">+</i></a> 
                                ...
                                <table cellspacing="0">
                                    <tbody>
                                        <tr class="cart-subtotal">
                                            <th>Cart Subtotal</th>
                                            <td><span class="amount">£ ${(total>0)?dcf.format(total):0}</span></td>
                                        </tr>
                                        ...
                                        <tr class="order-total">
                                            <th>Order Total</th>
                                            <td><strong><span class="amount">£ ${(total>0)?dcf.format(total):0}</span></strong> </td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
