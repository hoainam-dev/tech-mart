...
<!-- Favicon -->
        ...
        <link rel="stylesheet" href="includes/css/material-design-iconic-font.min.css">
        <!-- Font Awesome -->
        <link rel="stylesheet" href="includes/css/font-awesome.min.css">
        <!-- Font Awesome Stars-->
        <link rel="stylesheet" href="includes/css/fontawesome-stars.css">
        <!-- Meanmenu CSS -->
        ...
        <!-- Venobox CSS -->
        <link rel="stylesheet" href="includes/css/venobox.css">
        <!-- Nice Select CSS -->
        <link rel="stylesheet" href="includes/css/nice-select.css">
        <!-- Magnific Popup CSS -->
        <link rel="stylesheet" href="includes/css/magnific-popup.css">
        <!-- Bootstrap V4.1.3 Fremwork CSS -->
        <link rel="stylesheet" href="includes/css/bootstrap.min.css">
        <!-- Helper CSS -->
        <link rel="stylesheet" href="includes/css/helper.css">
        <!-- Main Style CSS -->
                                    ...
                                    <ul class="ht-menu">
                                        ...
                                        <li>
                                            ...
                                            <div class="language ht-language">
                                                <ul class="ht-setting-list">
                                                    <li class="active"><a href="#"><img src="includes/images/menu/flag-icon/1.jpg" alt="">English</a></li>
                                                    <li><a href="#"><img src="includes/images/menu/flag-icon/2.jpg" alt="">Français</a></li>
                                                </ul>
                                            </div>
                                        </li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="logo pb-sm-30 pb-xs-30">
                                    <a href="index.html">
                                        <img src="includes/images/menu/logo/1.jpg" alt="">
                                    </a>
                                </div>
                            </div>
...
<!-- Body Wrapper End Here -->
        ...
        <!-- Popper js -->
        <script src="includes/js/vendor/popper.min.js"></script>
        <!-- Bootstrap V4.1.3 Fremwork js -->
        <script src="includes/js/bootstrap.min.js"></script>
        <!-- Ajax Mail js -->
        <script src="includes/js/ajax-mail.js"></script>
        <!-- Meanmenu js -->
        ...
        <!-- Barrating -->
        <script src="includes/js/jquery.barrating.min.js"></script>
        <!-- Jquery-ui -->
        <script src="includes/js/jquery-ui.min.js"></script>
        <!-- Venobox -->
        <script src="includes/js/venobox.min.js"></script>
        <!-- Nice Select js -->
        <script src="includes/js/jquery.nice-select.min.js"></script>
        <!-- ScrollUp js -->
        <script src="includes/js/scrollUp.min.js"></script>
        <!-- Main/Activator js -->
